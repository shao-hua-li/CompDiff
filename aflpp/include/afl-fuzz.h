...
typedef struct afl_state {
  ...
  afl_forkserver_t diff_fsrv[MAX_NUM_DIFF];
  u32 diff_num;
  sharedmem_t      shm;
  ...
  u8 skip_deterministic,                /* Skip deterministic stages?       */
      ...
      flag_use_output;                     /* if the target's para speficify output file  */
...
#define N_FUZZ_SIZE (1 << 21)
  ...
  u64 total_crashes,                    /* Total number of crashes          */
      ...
      total_diffs,                     /* toal number of diffs    */
      unique_diffs;                     /* total number of unique diffs   */
...
void   setup_stdout_file_diff(afl_state_t *);
...
void   check_binary(afl_state_t *, u8 *, u8);
